...
def test_immutable_models():
    ...
    assert isinstance(ticker_copy, Ticker)
    ...
    assert isinstance(order_copy, Order)
...
def test_mutable_models():
    ...
    assert isinstance(price_copy, Price)
    ...
    assert isinstance(score_copy, ScoreMetrics)
